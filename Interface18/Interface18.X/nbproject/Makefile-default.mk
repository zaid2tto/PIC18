...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Interface18.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
${OBJECTDIR}/_ext/1980736469/PIC18_1.o: C:/Users/Zaid/Desktop/PIC18/Interface18/PIC18_1.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1980736469/PIC18_1.o.d 
	@${RM} ${OBJECTDIR}/_ext/1980736469/PIC18_1.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/_ext/1980736469/PIC18_1.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/_ext/1980736469/PIC18_1.lst\" -e\"${OBJECTDIR}/_ext/1980736469/PIC18_1.err\" $(ASM_OPTIONS)   -o\"${OBJECTDIR}/_ext/1980736469/PIC18_1.o\" \"C:/Users/Zaid/Desktop/PIC18/Interface18/PIC18_1.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/_ext/1980736469/PIC18_1.o"
	@${FIXDEPS} "${OBJECTDIR}/_ext/1980736469/PIC18_1.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Interface18.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"   -z__MPLAB_BUILD=1  -odist/${CND_CONF}/${IMAGE_TYPE}/Interface18.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
endif
